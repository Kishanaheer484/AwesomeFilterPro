...
async def next_page(bot, query):
    ...
    btn.insert(0, 
        [
            InlineKeyboardButton('🔋 Hᴏᴡ ᴛᴏ ᴅᴏᴡɴʟᴏᴀᴅ 🔋', url='https://t.me/Flix_Movie_in')
        ]
    )
    btn.insert(1, 
        [
            InlineKeyboardButton('ɢʀᴏᴜᴘ', url='https://t.me/Flix_Movie_in'),
            InlineKeyboardButton('ᴄᴏɴᴛᴀᴄᴛ', url='https://t.me/Flix_Movie_in')
        ]
    )
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            InlineKeyboardButton('🤖 ᴜᴘᴅᴀᴛᴇs 🤖', url='https://t.me/Flix_Movie_in'),
            InlineKeyboardButton('💥 ᴍᴏᴠɪᴇs ♥️', url='https://t.me/newSouthmovieinhindid')
            ],[
            InlineKeyboardButton('💞 sᴜᴘᴘᴏʀᴛ 💞', url='https://t.me/MoviesSearchgroup_in'),
            InlineKeyboardButton('👩‍💻 ʀᴇᴘᴏ ✨', url='https://t.me/kishanyadav484'),
            ],[
        ...
        buttons = [[
            InlineKeyboardButton('🙄 ᴏᴡɴᴇʀ 🙄', url='https://t.me/Flix_Movie_in'),
            InlineKeyboardButton('🤖 ᴜᴘᴅᴀᴛᴇs 🤖', url='https://t.me/Flix_Movie_in'),
        ],[
            InlineKeyboardButton('👩‍💻 sᴏᴜʀᴄᴇ ᴄᴏᴅᴇ 👩‍💻', url='https://t.me/kishanyadav484'), #Please Change your bot username
            InlineKeyboardButton('😍 sʜᴀʀᴇ ᴍᴇ 😍', url=f'https://t.me/kishanyadav484}'),
        ],[
            InlineKeyboardButton('🔐 ᴄʟᴏsᴇ 🔐', callback_data='close_data')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
